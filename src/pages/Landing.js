      ...
      <div className="Landing">
        ...
        <div className="jumbotron jumbotron-fluid pt-3 mb-0">
          <div className="container pt-3">
            ...
            <p className="h5">
              The remaining 70% of the STX that miners forward is distributed to CityCoin holders
              who Stack their tokens.
            </p>
            <p className="h5">
              Stacking requires holders to lock their CityCoins for determined “reward cycles”,
              where they are transferred to the smart contract and can be reclaimed after the cycles
              are complete.
            </p>
            <p className="h5">
